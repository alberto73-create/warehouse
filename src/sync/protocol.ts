...
export interface SyncRequest{deviceId:string;cursor:number;operations:Movement[]}
export interface SyncResponse{accepted:string[];changes:Movement[];cursor:number;serverHasNewer:boolean}
